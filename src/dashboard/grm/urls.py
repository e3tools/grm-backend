...
urlpatterns = [
    ...
    path(
        ...
        name="new_issue_step_1",
    ),
    path(
        "new-issue-step-2/<int:issue>/",
        views.NewIssuePersonFormView.as_view(),
        name="new_issue_step_2",
    ),
    path(
        "new-issue-step-3/<int:issue>/",
        views.NewIssueDetailsFormView.as_view(),
        name="new_issue_step_3",
    ),
    path(
        "new-issue-step-4/<int:issue>/",
        views.NewIssueLocationFormView.as_view(),
        name="new_issue_step_4",
    ),
    path(
        "new-issue-step-5/<int:issue>/",
        views.NewIssueConfirmFormView.as_view(),
        name="new_issue_step_5",
    ),
    path(
        "new-issue-step-6/<int:issue>/",
        views.NewIssueConfirmationFormView.as_view(),
        name="new_issue_step_6",
    ),
    ...
    path(
        "issue-detail/<int:issue>/",
        views.IssueDetailsFormView.as_view(),
        name="issue_detail",
    ),
    path(
        "get-sensitive-issue-data/",
    ...
    path(
        "submit-issue-open-status/<int:issue>/",
        views.SubmitIssueOpenStatusView.as_view(),
        name="submit_issue_open_status",
    ),
    path(
        "submit-issue-research-result/<int:issue>/",
        views.SubmitIssueResearchResultFormView.as_view(),
        name="submit_issue_research_result",
    ),
    path(
        "submit-issue-reject-reason/<int:issue>/",
        views.SubmitIssueRejectReasonFormView.as_view(),
